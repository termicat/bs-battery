...
export type ConfigSelectTableOptions = { };

export type ConfigSelectTableProps = ConfigItemProps<'select-table', ConfigSelectTableOptions>;

export default function ConfigSelectTable(props:ConfigSelectTableProps) {
  const {
    field,
    label,
